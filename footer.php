...
<div class="container-fluid bg-light">
    <div class="footer row justify-content-between align-items-center fixed-bottom position-relative">
    ...
    <p class="sm-text text-center">2021 Copyright Kelly's Dog Collars. All rights reserved</p>
</div>
</body>
</html>